...
> **Spotlight CLI** is an [API Commons](https://github.com/api-commons) fork of
> [Stoplight Spectral](https://github.com/stoplightio/spectral), the open-source
> JSON/YAML linter for OpenAPI, AsyncAPI, and Arazzo. See [FORK.md](./FORK.md)
> for provenance, attribution, and changes from upstream. The ruleset format the
